...
void cgpops_go(doubleMat& cgpopsResults)
{
    ...
    // Phase 1 parameters
    nxG[0]  = 3;    // Number of state components in phase 1
    ...
    nppG[0] = 0;    // Number of phase parameters in phase 2
    ...
    */ 
    ...
    x0u1[1] = y0;       //initial state upper 0
    x0u1[2] = theta0;  //initial state upper theta0

    xl1[0]  = xmin;    //state lower xmin
    xl1[1]  = ymin;    //state lower ymin
    xl1[2]  = thetamin; //state lower thetamin

    xu1[0]  = xmax;    //state upper xmax
    xu1[1]  = ymax;    //state upper ymax
    xu1[2]  = thetamax; //state upper theatamax

    xfl1[0] = xf;      //final state lower xf
    xfl1[1] = yf;      //final state lower yf
    xfl1[2] = thetamin; //final state lower thetamin
    ...
    */
    ...
    /*
    t0g1[0] = t0;		//guess.phase.time [linespace(t0,tfmax2,n]
    t0g1[1] = tfmax2;i  //do not use block code
    t0g1[2] = tn;
    */
    ...
    */
    ...
    setNLPPGG(phase1,x0g1,xfg1,u0g1,ufg1,qg1,t0g1, tfg1);//this takes a intial guess state, final guess state, control guess state, control final guess state, guess phase integralm and time guess
